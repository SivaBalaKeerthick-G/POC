...
Aggregates query and document stats from PostgreSQL for the dashboard.
"""
import sys
...
app = FastAPI(
    title="CogniDoc Metrics Service",
    description="Dashboard metrics aggregated from PostgreSQL.",
    version="1.0.0",
    lifespan=lifespan,
)
